...
\textbf{François Alla} &  Président \\
PU PH, Université de Bordeaux &   \\
\textbf{Gwenn Menvielle} &  Rapporteur \& Examinatrice \\
PU, Inserm, Sorbonne Université, Paris, France   &   \\
\textbf{Julie Josse} &  Rapporteur \& Examinatrice \\
INRIA Sophia-Antipolis, IDESP, Montpellier, France   &   \\
\textbf{Inès Vaz-Duarte-Luis} &  Examinatrice \\
Université Paris Saclay, Paris, France   &  \\
\textbf{Fabien Reyal} &  Directeur de thèse \\
PU PH, Institut Curie, Université de Paris, Paris, France &   \\
...
\include{chapters/1-characterization}
\include{chapters/2-accessibility}
\include{chapters/3-accessibility-optimization}
\include{chapters/4-patients-routes}
\include{chapters/5-simca}
\include{chapters/6-transparent-healthcare}
