...
\begin{titlepage}
  ...
  \footnotesize Thèse préparée dans les unités de recherche de l'Institut Curie Paris et INRIA Paris, sous la direction de Fabien Reyal, MD, PhD, et la co-direction de Marc Lelarge, PhD.\\
  \vspace{15mm}
...
\begin{singlespace}
  ...
  \include{chapters/5-transparent-healthcare}
  \include{chapters/6-simca}
